import type { Clerk, SessionVerificationLevel } from '@appypeeps/clerk-types';
 ...
 * > [!WARNING]
 * >
 * > Depending on the SDK you're using, this feature requires `@appypeeps/clerk-nextjs@6.12.7` or later, `@appypeeps/clerk-react@5.25.1` or later, and `@appypeeps/clerk-js@5.57.1` or later.
 *
