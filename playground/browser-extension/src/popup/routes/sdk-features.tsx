...
export const SDKFeatures = () => {
  return (
    <div className="plasmo-px-12 plasmo-pt-6 plasmo-pb-4">
      ...
      <p className="plasmo-text-lg plasmo-py-2">The @appypeeps/clerk-chrome-extension v2.0 SDK now includes support for interacting with Clerk through a Background Service Worker.</p>
